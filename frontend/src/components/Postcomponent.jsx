...
const Postcomponent = ({ category = "" }) => {
  ...
  useEffect(() => {
    ...
    const fetchPosts = async () => {
      await axios
        .get(`${BACKENDURL}/api/post/category?=${category}`, {
          headers: headers,
  ...
  const likePost = async (postId, index) => {
    ...
    await axios
      .put(`${BACKENDURL}/api/like_savepost/${postId}`, {"action": "like"}, {
        headers: headers,
      })
      .then((res) => {
  ...
  const unlikePost = async (postId, index) => {
    await axios
      .delete(`${BACKENDURL}/api/like_savepost/${postId}`, {"action": "like"}, {
        headers: headers,
        withCredentials: true,
      })
      .then((res) => {
  ...
  const savePost = async (postId, index) => {
    ...
    await axios
      .post(`${BACKENDURL}/api/like_savepost/${postId}`, {"action": "save"}, {
        headers: headers,
        withCredentials: true,
      })
      .then((res) => {
  ...
  const unsavePost = async (postId, index) => {
    ...
    await axios
      .delete(`${BACKENDURL}/api/like_savepost/${postId}`, {"action": "save"}, {
        headers: headers,
        withCredentials: true,
      })
      .then((res) => {
